...
<body>
    ...
    <input value="<?php echo $row['payable'] ?>" name="tAmt" type="hidden">
    <input value="<?php echo $row['payable'] ?>" name="amt" type="hidden">
    <input value="0" name="txAmt" type="hidden">
    <input value="0" name="psc" type="hidden">
    <input value="0" name="pdc" type="hidden">
    <input value="EPAYTEST" name="scd" type="hidden">
    <input value="ee2c3ca1-696b-4cc5-a6be-2c40d929d453" name="pid" type="hidden">
    <input value="<?php echo $url?>/user/esewa_payment_success.php?q=su" type="hidden" name="su">
    <input value="<?php echo $url?>/user/esewa_payment_failed.php?q=f" type="hidden" name="fu">
